...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link"   href="pathologist.php">Home</a>
                    </li>
                    ...
                    <li class="nav-item">
                        <a class="nav-link"  href="resubmit.php">Re-submit Report</a>
                    </li>
    ...
    <form class="container d-flex align-items-center justify-content-center py-5" autocomplete = "off" action="pathology-report-view.php" method="POST">
