...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="resubmit.php">Re-submit Report</a>
                    </li>
                    <li class="nav-item">
    ...
    <form autocomplete="off" class="container d-flex align-items-center justify-content-center py-5" action="resubmit.php" method="POST">
    ...
    <?php
        $flag1=0;
                if(isset($_POST['submit']))
                {
                                    ...
                                    if(isset($_POST[$Date])&&!empty($_FILES[$report]['tmp_name']))
                                    {
                                        $pdf1 = addslashes(file_get_contents($_FILES[$report]['tmp_name']));
                                            ...
                                            if($conn->query($addfile))
                                            {
                                                ...
                                                $mail->Subject="Updated Report From Med-Alexa";
                                                $mail->Body="Dear ".$row['name']." , Your ".$report1." Report has been replaced with another report due to some technical issue your new ".$report1." Report is attached here.\n\nSorry for Inconvenience";
                        ...
                        {
                            echo "no";
                            $errors['No data'] = "Does not have any data";
                        }
                }
            ?>
    <?php
    ...
    <div class="container items">
        ...
        <table class="table">
            ...
            <form action="resubmit.php" method="POST" enctype="multipart/form-data">
            <tbody>
            <?php
