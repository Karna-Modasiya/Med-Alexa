<?php
    ...
    $search = "SELECT * FROM `pharmacist` WHERE `id`='$id'";
    ...
    if (isset($_POST['update'])) {
        ...
        $email =$_POST['email'];
        $phone =$_POST['phone'];
        $update = "UPDATE pharmacist SET email = '$email', name = '$name', phone='$phone' WHERE id='$id'";
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item">
                        <a class="nav-link " aria-current="page" href="pharmacist.php">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active" href="pharmacist-profile.php">Profile</a>
                    </li>
                    <li class="nav-item">
    ...
    phid = "<?php echo $id; ?>";
    phname = "<?php echo $name; ?>";
    phpass = "<?php echo $password; ?>";
    phtype = "<?php echo $type; ?>";
    phphone = "<?php echo $phone; ?>";
    phemail = "<?php echo $email; ?>";
