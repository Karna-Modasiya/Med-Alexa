<?php
    ...
    $search = "SELECT * FROM `operator` WHERE `id`='$id'";
    ...
    if (isset($_POST['update'])) {
        ...
        $email =$_POST['email'];
        $phone =$_POST['phone'];
        $update = "UPDATE operator SET email = '$email', name = '$name', phone='$phone' WHERE id='$id'";
...
<body>
        ...
        <a class="navbar-brand" href="#">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item fsize">
                        <a class="nav-link active" href="operator-profile.php"> Operator Profile</a>
                    </li>
                    <li class="nav-item fsize">
    ...
    oid = "<?php echo $id; ?>";
    oname = "<?php echo $name; ?>";
    opass = "<?php echo $password; ?>";
    otype = "<?php echo $type; ?>";
    ophone = "<?php echo $phone; ?>";
